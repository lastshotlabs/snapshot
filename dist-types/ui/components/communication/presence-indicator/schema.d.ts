...
export declare const presenceIndicatorConfigSchema: z.ZodObject<{
    ...
    status: z.ZodUnion<[z.ZodEnum<["online", "offline", "away", "busy", "dnd"]>, z.ZodObject<{
        from: z.ZodString;
        transform: z.ZodOptional<z.ZodEnum<["uppercase", "lowercase", "trim", "length", "number", "boolean", "string", "json", "keys", "values", "first", "last", "count", "sum", "join", "split", "default"]>>;
        transformArg: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodNumber]>>;
    }, "strict", z.ZodTypeAny, {
    ...
    slots: z.ZodOptional<z.ZodObject<Record<"root" | "dot" | "label", z.ZodOptional<z.ZodObject<{
