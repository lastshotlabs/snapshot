...
export declare const favoriteButtonConfigSchema: z.ZodObject<{
    ...
    active: z.ZodOptional<z.ZodUnion<[z.ZodBoolean, z.ZodObject<{
        from: z.ZodString;
        transform: z.ZodOptional<z.ZodEnum<["uppercase", "lowercase", "trim", "length", "number", "boolean", "string", "json", "keys", "values", "first", "last", "count", "sum", "join", "split", "default"]>>;
        transformArg: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodNumber]>>;
    }, "strict", z.ZodTypeAny, {
    ...
    toggleAction: z.ZodOptional<z.ZodType<import("@lastshotlabs/frontend-contract/actions").ActionConfig, z.ZodTypeDef, import("@lastshotlabs/frontend-contract/actions").ActionConfig>>;
    ...
    toggleAction?: import("@lastshotlabs/frontend-contract/actions").ActionConfig | undefined;
}, {
    type: "favorite-button";
    background?: string | {
        size?: "auto" | "cover" | "contain" | undefined;
