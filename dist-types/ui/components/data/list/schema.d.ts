import { z } from "zod";
export declare const listSlotNames: readonly ["root", "list", "item", "itemBody", "itemLink", "itemTitle", "itemDescription", "itemIcon", "itemBadge", "divider", "liveBanner", "liveText", "emptyState", "loadingState", "loadingItem", "loadingIcon", "loadingBody", "loadingTitle", "loadingDescription", "errorState"];
export declare const listItemSlotNames: readonly ["item", "itemBody", "itemLink", "itemTitle", "itemDescription", "itemIcon", "itemBadge", "divider"];
/**
...
export declare const listItemSchema: z.ZodObject<{
    ...
    badge: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodObject<{
        from: z.ZodString;
        transform: z.ZodOptional<z.ZodEnum<["uppercase", "lowercase", "trim", "length", "number", "boolean", "string", "json", "keys", "values", "first", "last", "count", "sum", "join", "split", "default"]>>;
        transformArg: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodNumber]>>;
    }, "strict", z.ZodTypeAny, {
    ...
    slots: z.ZodOptional<z.ZodObject<Record<"item" | "divider" | "itemIcon" | "itemBadge" | "itemBody" | "itemLink" | "itemTitle" | "itemDescription", z.ZodOptional<z.ZodObject<{
    ...
    badgeColor?: "destructive" | "success" | "warning" | "info" | "primary" | "secondary" | undefined;
}, {
    title: string | {
        from: string;
        transform?: "string" | "number" | "boolean" | "uppercase" | "lowercase" | "trim" | "length" | "json" | "keys" | "values" | "first" | "last" | "count" | "sum" | "join" | "split" | "default" | undefined;
