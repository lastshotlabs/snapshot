import { z } from "zod";
export declare const oauthButtonsSlotNames: readonly ["root", "heading", "provider", "providerIcon", "providerLabel", "providerDescription"];
export declare const oauthButtonsConfigSchema: z.ZodObject<{
    ...
    heading: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodObject<{
        from: z.ZodString;
        transform: z.ZodOptional<z.ZodEnum<["uppercase", "lowercase", "trim", "length", "number", "boolean", "string", "json", "keys", "values", "first", "last", "count", "sum", "join", "split", "default"]>>;
        transformArg: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodNumber]>>;
    }, "strict", z.ZodTypeAny, {
    ...
    slots: z.ZodOptional<z.ZodObject<Record<"root" | "heading" | "provider" | "providerIcon" | "providerLabel" | "providerDescription", z.ZodOptional<z.ZodObject<{
