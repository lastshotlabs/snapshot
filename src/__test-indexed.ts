...
type ResourcesSection = ManifestConfig["resources"];
...
type StateSection = ManifestConfig["state"];
...
type StateRecordElement = ManifestConfig["state"] extends Record<string, infer S> ? S : never;
type ResourcesRecordElement = ManifestConfig["resources"] extends Record<string, infer R> ? R : never;
