...
export declare class WebSocketManager<TEvents extends Record<string, unknown> = Record<string, unknown>> {
    ...
    on<K extends keyof TEvents | "*">(event: K, handler: (data: K extends keyof TEvents ? TEvents[K] : unknown) => void): void;
    off<K extends keyof TEvents | "*">(event: K, handler: (data: K extends keyof TEvents ? TEvents[K] : unknown) => void): void;
    reconnect(): void;
    disconnect(): void;
}
export {};
