...
import type { AtomRegistry, JotaiStore, StateConfig as RuntimeStateConfig, StateConfigMap } from "../state/types";
/**
...
export interface FromRef {
    ...
    transform?: "uppercase" | "lowercase" | "trim" | "length" | "number" | "boolean" | "string" | "json" | "keys" | "values" | "first" | "last" | "count" | "sum" | "join" | "split" | "default";
