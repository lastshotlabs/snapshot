...
let builtInFlavorsRegistered = false;
const registerFlavor = defineFlavor;
 ...
 */
export function registerBuiltInFlavors(): void {
  if (builtInFlavorsRegistered) {
    return;
  }

  builtInFlavorsRegistered = true;

  /** Clean, professional. Default shadcn neutral palette. */
  registerFlavor("neutral", {
    displayName: "Neutral",
    colors: {
      background: "1 0 0",
      card: "1 0 0",
      ...
      success: "0.586 0.209 145.071",
      warning: "0.681 0.162 75.834",
      info: "0.546 0.245 262.881",
      border: "0.922 0 0",
      input: "0.922 0 0",
      ring: "0.708 0 0",
      chart: [
    ...
    darkColors: {
      ...
      success: "0.648 0.2 145.071",
      warning: "0.741 0.152 75.834",
      info: "0.618 0.22 262.881",
      border: "0.3 0 0",
      input: "0.3 0 0",
      ring: "0.556 0 0",
      chart: [
  ...
  registerFlavor("midnight", {
    ...
    darkColors: {
      ...
      sidebar: "0.15 0.02 265",
      primary: "0.58 0.16 265",
  ...
  registerFlavor("rose", {
    ...
    darkColors: {
      ...
      sidebar: "0.16 0.018 350",
      primary: "0.58 0.17 350",
  ...
  registerFlavor("emerald", {
    ...
    darkColors: {
      ...
      sidebar: "0.16 0.018 160",
      primary: "0.56 0.15 160",
  ...
  registerFlavor("ocean", {
    ...
    darkColors: {
      ...
      sidebar: "0.15 0.02 220",
      primary: "0.54 0.15 230",
