...
function sanitizeMarkdownProps<T extends object>(
  props: T,
): Omit<T, "node" | "ref"> {
  const {
    node: _node,
          ...
          <code
            ...
            className={
              [
                codeClassName,
                isInline
                  ? surfaces.inlineCode.className
                  : surfaces.blockCode.className,
              ]
                .filter(Boolean)
                .join(" ") || undefined
            }
            data-snapshot-id={
              isInline ? `${rootId}-inlineCode` : `${rootId}-blockCode`
            }
            style={
              isInline ? surfaces.inlineCode.style : surfaces.blockCode.style
            }
          >
            {children}
          </code>
