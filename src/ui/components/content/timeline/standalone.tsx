...
export function TimelineBase({
  ...
  if (loading) {
    const loadingStateSurface = resolveSurfacePresentation({
      ...
      implementationBase: { padding: "var(--sn-spacing-md, 1rem)" },
    ...
    const loadingMetaSurface = resolveSurfacePresentation({
      ...
      componentSurface: slots?.loadingMeta,
    });
  ...
  if (items.length === 0) {
    const emptyStateSurface = resolveSurfacePresentation({
      ...
      implementationBase: {
        ...
        style: { padding: "var(--sn-spacing-lg, 1.5rem)", textAlign: "center" },
      },
      ...
      {items.map((item, index) => {
        ...
        const itemSurface = resolveSurfacePresentation({
          ...
          implementationBase: {
            ...
            hover: onItemClick
              ...
              : undefined,
            focus: onItemClick ? { ring: true } : undefined,
            style: {
        ...
        const markerColumnSurface = resolveSurfacePresentation({
          ...
          implementationBase: {
            ...
            alignItems: "center",
            style: { flexShrink: 0, width: dotSize },
          },
        ...
        const metaSurface = resolveSurfacePresentation({
          ...
          implementationBase: {
            fontSize: "xs",
            color: "var(--sn-color-muted-foreground, #6b7280)",
            style: { whiteSpace: "nowrap", flexShrink: 0 } as CSSProperties,
          },
