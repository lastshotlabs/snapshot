...
export function ReactionBarBase({
  ...
  const addWrapperSurface = resolveSurfacePresentation({
    ...
    componentSurface: slots?.addWrapper,
  });
        ...
        {reactions.map((reaction, idx) => {
          ...
          const reactionSurface = resolveSurfacePresentation({
            ...
            implementationBase: {
              ...
              transition: "all",
              style: {
                border: `1px solid ${reaction.active ? "var(--sn-color-primary, #2563eb)" : "var(--sn-color-border, #e5e7eb)"}`,
          ...
          return (
            <div key={`${reaction.emoji}-${idx}`}>
              <ButtonControl
                ...
                ariaPressed={reaction.active ?? false}
                surfaceId={reactionId}
                onClick={() =>
