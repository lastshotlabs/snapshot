...
export function ChatWindowBase({
  ...
  const subtitleS = resolveSurfacePresentation({
  ...
  const threadS = resolveSurfacePresentation({
    ...
    componentSurface: slots?.threadArea,
  });
  const typingS = resolveSurfacePresentation({
    surfaceId: `${rootId}-typingArea`,
    implementationBase: { style: { flexShrink: 0, minHeight: "1.5rem" } },
    componentSurface: slots?.typingArea,
  });
    ...
    <>
      ...
      >
        {showHeader ? (
          ...
          >
            ...
            <div
              ...
              className={titleGrpS.className}
              style={titleGrpS.style}
            >
              {title ? (
                <div
        ...
        <div
          ...
          className={threadS.className}
          style={threadS.style}
        >
          {threadSlot}
        </div>
        {showTypingIndicator && typingSlot ? (
          <div
            data-snapshot-id={`${rootId}-typingArea`}
            className={typingS.className}
            style={typingS.style}
          >
            {typingSlot}
          </div>
      ...
      <SurfaceStyles css={titleGrpS.scopedCss} />
      <SurfaceStyles css={titleS.scopedCss} />
      <SurfaceStyles css={subtitleS.scopedCss} />
      <SurfaceStyles css={threadS.scopedCss} />
      <SurfaceStyles css={typingS.scopedCss} />
