...
/**
 * Advanced list component with drag-and-drop, virtual scroll, and context menus.
 * This is the full manifest-based rendering path for lists that use advanced features.
 */
export function AdvancedListComponent({ config }: { config: ListConfig }) {
  ...
  return (
    ...
    >
      ...
      {/* Empty state */}
      {!loading && !fetchError && limitedItems.length === 0 && (
        emptyStateConfig ? (
          <div
      ...
      {/* Items */}
      {!loading && !fetchError && dropEnabled ? (
        <ManagedListItems
          rootId={rootId}
          containerId={containerId}
