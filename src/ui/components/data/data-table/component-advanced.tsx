...
/**
 * Advanced DataTable with drag-and-drop, virtual scroll, context menus,
 * expandable rows, and toolbar support. This is the full manifest-based
 * rendering path.
 */
export function AdvancedDataTable({ config }: { config: DataTableConfig }) {
