...
export const emptyStateConfigSchema = z
  .object({
    ...
    active: activeConfigSchema.optional(),
    background: componentBackgroundSchema.optional(),
    backgroundColor: statefulElementSchema.shape.backgroundColor.optional(),
    padding: z.union([spacingEnum, z.string(), z.number()]).optional(),
    paddingX: z.union([spacingEnum, z.string(), z.number()]).optional(),
    paddingY: z.union([spacingEnum, z.string(), z.number()]).optional(),
    margin: z.union([spacingEnum, z.string(), z.number()]).optional(),
    marginX: z.union([spacingEnum, z.string(), z.number()]).optional(),
    marginY: z.union([spacingEnum, z.string(), z.number()]).optional(),
    gap: z.union([spacingEnum, z.string(), z.number()]).optional(),
    ...
    color: z.string().optional(),
    borderRadius: z.union([spacingEnum, z.string(), z.number()]).optional(),
    border: z.string().optional(),
    shadow: z.string().optional(),
    opacity: z.union([z.string(), z.number()]).optional(),
    overflow: z.string().optional(),
    cursor: z.string().optional(),
    position: statefulElementSchema.shape.position.optional(),
    inset: z.union([z.string(), z.number()]).optional(),
    display: statefulElementSchema.shape.display.optional(),
    flexDirection: statefulElementSchema.shape.flexDirection.optional(),
    ...
    fontSize: z.union([spacingEnum, z.string(), z.number()]).optional(),
